...
export const environment = {
  ...
  apiUrl_Payment: 'https://preprod.riskassessment.rushforsafety.com/api/v1',
  ...
  apiUrl_EMC_LV:'https://preprod.lv.rushforsafety.com/api/v2',
  apiUrl_LPS_RISK:'https://preprod.lps.rushforsafety.com/api/v1',
  sessionTimeOut: 3600,
  ...
  shapes:[
    ...
    {imageSource: '../../assets/img/earthground.png', imageName: 'Ground1', id: 20},
