...
export class InspectionVerificationBasicInformationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.step1Form = this._formBuilder.group({
      ...
      designer1AcknowledgeArr: this._formBuilder.array([
        this.createDesigner1AcknowledgeForm(),
      ]),
      designer2AcknowledgeArr: this._formBuilder.array([
        this.createDesigner2AcknowledgeForm(),
      ]),
      contractorAcknowledgeArr: this._formBuilder.array([
        this.createContractorAcknowledgeForm(),
      ]),
      inspectorAcknowledgeArr: this._formBuilder.array([
        this.createInspectorAcknowledgeForm(),
      ]),
  ...
  showWiringAge(e: any) {
    ...
    if (changedValue == 'New installation') {
      ...
      this.step1Form.controls['showField1'].setValidators([
        Validators.required,
      ]);
      this.step1Form.controls['showField1'].updateValueAndValidity();
    }
  ...
  showEstimatedAge(e: any) {
    ...
    if (changedValue == 'Yes') {
      ...
      this.step1Form.controls['showField2'].setValidators([
        Validators.required,
      ]);
  ...
  retrieveSiteInfo(e: any) {
    ...
    for (let arr of this.departmentListInspec) {
      if (arr.departmentName == changedValue) {
        this.siteService
          .retrieveSiteInfo(arr.clientName, arr.departmentName)
          .subscribe((data) => {
  ...
  designer1changeCountry(e: any) {
    ...
    for (let arr of this.countryList) {
      if (arr.name == changedValue) {
        this.siteService.retrieveState(arr.code).subscribe((data) => {
  ...
  addDesigner() {
    ...
    this.f.designer2Arr.controls[0].controls['personName'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls[
      'personName'
    ].updateValueAndValidity();

    this.f.designer2Arr.controls[0].controls['personContactNo'].setValidators([
      Validators.required,
      Validators.maxLength(10),
    ]);
    this.f.designer2Arr.controls[0].controls[
    ...
    this.f.designer2Arr.controls[0].controls['personMailID'].setValidators([
      Validators.required,
      Validators.pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$'),
    ]);
    this.f.designer2Arr.controls[0].controls[
    ...
    this.f.designer2Arr.controls[0].controls['managerName'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls[
      'managerName'
    ...
    this.f.designer2Arr.controls[0].controls['managerContactNo'].setValidators([
      Validators.required,
      Validators.maxLength(10),
    ]);
    this.f.designer2Arr.controls[0].controls[
    ...
    this.f.designer2Arr.controls[0].controls['managerMailID'].setValidators([
      Validators.required,
      Validators.pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$'),
    ]);
    this.f.designer2Arr.controls[0].controls[
    ...
    this.f.designer2Arr.controls[0].controls['companyName'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls[
      'companyName'
    ...
    this.f.designer2Arr.controls[0].controls['addressLine1'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls[
      'addressLine1'
    ...
    this.f.designer2Arr.controls[0].controls['addressLine2'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls[
      'addressLine2'
    ...
    this.f.designer2Arr.controls[0].controls['landMark'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls[
      'landMark'
    ...
    this.f.designer2Arr.controls[0].controls['country'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls[
      'country'
    ...
    this.f.designer2Arr.controls[0].controls['state'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls['state'].updateValueAndValidity();

    this.f.designer2Arr.controls[0].controls['pinCode'].setValidators(
      Validators.required
    );
    this.f.designer2Arr.controls[0].controls[
      'pinCode'
  ...
  nextTab() {
    ...
    this.step1Form.value.designer1Arr[0].declarationSignature =
      this.step1Form.value.designer1AcknowledgeArr[0].signature;
    this.step1Form.value.designer1Arr[0].declarationName =
      this.step1Form.value.designer1AcknowledgeArr[0].declarationName;
    this.step1Form.value.designer1Arr[0].declarationDate =
      this.step1Form.value.designer1AcknowledgeArr[0].declarationDate;

    this.step1Form.value.designer2Arr[0].signatorRole = this.designerRole;
    if (
      this.step1Form.value.designer2AcknowledgeArr[0].signature != '' &&
      this.step1Form.value.designer2AcknowledgeArr[0].declarationName != '' &&
      this.step1Form.value.designer2AcknowledgeArr[0].declarationDate != ''
    ) {
      this.step1Form.value.designer2Arr[0].declarationSignature =
        this.step1Form.value.designer2AcknowledgeArr[0].signature;
      this.step1Form.value.designer2Arr[0].declarationName =
        this.step1Form.value.designer2AcknowledgeArr[0].declarationName;
      this.step1Form.value.designer2Arr[0].declarationDate =
        this.step1Form.value.designer2AcknowledgeArr[0].declarationDate;
    }

    this.step1Form.value.contractorArr[0].signatorRole = this.contractorRole;
    this.step1Form.value.contractorArr[0].declarationSignature =
      this.step1Form.value.contractorAcknowledgeArr[0].signature;
    this.step1Form.value.contractorArr[0].declarationName =
      this.step1Form.value.contractorAcknowledgeArr[0].declarationName;
    this.step1Form.value.contractorArr[0].declarationDate =
      this.step1Form.value.contractorAcknowledgeArr[0].declarationDate;

    this.step1Form.value.inspectorArr[0].signatorRole = this.inspectorRole;
    this.step1Form.value.inspectorArr[0].declarationSignature =
      this.step1Form.value.inspectorAcknowledgeArr[0].signature;
    this.step1Form.value.inspectorArr[0].declarationName =
      this.step1Form.value.inspectorAcknowledgeArr[0].declarationName;
    this.step1Form.value.inspectorArr[0].declarationDate =
      this.step1Form.value.inspectorAcknowledgeArr[0].declarationDate;

    this.reportDetails.userName = this.email;

    //country code
    this.step1Form.value.designer1Arr[0].personContactNo =
      '+' +
      this.countryCode +
      '-' +
      this.step1Form.value.designer1Arr[0].personContactNo;
    this.step1Form.value.designer1Arr[0].managerContactNo =
      '+' +
      this.countryCode1 +
      '-' +
      this.step1Form.value.designer1Arr[0].managerContactNo;

    this.step1Form.value.designer2Arr[0].personContactNo =
      '+' +
      this.countryCode2 +
      '-' +
      this.step1Form.value.designer2Arr[0].personContactNo;
    this.step1Form.value.designer2Arr[0].managerContactNo =
      '+' +
      this.countryCode3 +
      '-' +
      this.step1Form.value.designer2Arr[0].managerContactNo;

    this.step1Form.value.contractorArr[0].personContactNo =
      '+' +
      this.countryCode4 +
      '-' +
      this.step1Form.value.contractorArr[0].personContactNo;
    this.step1Form.value.contractorArr[0].managerContactNo =
      '+' +
      this.countryCode5 +
      '-' +
      this.step1Form.value.contractorArr[0].managerContactNo;

    this.step1Form.value.inspectorArr[0].personContactNo =
      '+' +
      this.countryCode6 +
      '-' +
      this.step1Form.value.inspectorArr[0].personContactNo;
