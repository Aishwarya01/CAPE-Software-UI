...
export class InspectionVerificationService {
  ...
  public updateBasic(reportDetails: Reportdetails): Observable<any> {
    return this.http.put<any>(this.apiUrl2 + '/updateInstalReport', reportDetails, { responseType: 'text' as 'json' })
  }
  public updateSupply(supply: Supplycharacteristics): Observable<any> {
    return this.http.put<any>(this.apiUrl2 + '/updateCharacteristics', supply, { responseType: 'text' as 'json' })
  }
  public updateIncoming(incoming: InspectionDetails): Observable<any> {
    return this.http.put<any>(this.apiUrl2 + '/updateInspectionDetails', incoming, { responseType: 'text' as 'json' })
  }
  public updateTesting(testing: TestingDetails): Observable<any> {
    return this.http.put<any>(this.apiUrl2 + '/updatePeriodicTesting', testing, { responseType: 'text' as 'json' })
  }
  public updateSummary(summary: Summary): Observable<any> {
    return this.http.put<any>(this.apiUrl2 + '/updateSummary', summary, { responseType: 'text' as 'json' })
  }
