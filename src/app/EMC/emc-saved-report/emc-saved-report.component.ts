...
export class EmcSavedReportComponent implements OnInit {
  ...
  savedReportsEmcColumns: string[] = [ 'userName', 'projectName', 'consultantName', 'contractorName', 'dealerContractorName' , 'address', 'createdDate', 'createdBy','continue'];
  savedReportEmc_dataSource!: MatTableDataSource<EmcFacilityData[]>;
 ...
 completedFilterData: any=[];
   ...
   constructor(private router: ActivatedRoute,
               ...
               public emcService: EmcSavedReportService,
  ...
  //      //
  //      this.emcService.retrieveListOfEmc(this.email).subscribe(
  //        data => {
  ...
  //        this.emcService.retrieveListOfEmc(this.currentUser1.assignedBy).subscribe(
  //          data => {
  ...
  //  }
   ...
   continue(basicLpsId: any,clientName: any) {
     this.emcParent.continue(basicLpsId,clientName);
   } 
 }
