...
export class AirterminationService {
  ...
  public saveAirtermination(airtermination:Airtermination): Observable<any> {
    return this.http.post<Airtermination>(this.apiUrl + '/lps/addAirTerminationLps', airtermination,{ responseType: 'text' as 'json' })
  }

  public updateAirtermination(airTermination: Airtermination): Observable<any> {
    return this.http.put<any>(this.apiUrl + '/lps/updateAirTerminationLps', airTermination,{ responseType: 'text' as 'json' });
  }

  public retriveAirTerminationDetails(basicLpsId: any): Observable<any>{
    return this.http.get<any>(this.apiUrl + '/lps/retrieveAirTerminationLps' + '/' +basicLpsId, { responseType: 'text' as 'json' })
  }
