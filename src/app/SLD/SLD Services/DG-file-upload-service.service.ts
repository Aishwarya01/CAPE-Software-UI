...
export class DGFileUploadServiceService {
  ...
  public retriveFile(nodeId:any) {
    return this.http.get<any>(this.apiUrl5 + '/retrieveNodeFileName'+'/DesielGenerator'+'/'+nodeId, { responseType:'text' as 'json'})
  }


  public downloadFile(nodeId:any) {
    return this.http.get(this.apiUrl5 + '/downloadNodeFile'+'/DesielGenerator'+'/'+nodeId, { responseType:'blob'}).subscribe(
      data =>{
    ...
    public deleteFile(nodeId:any): Observable<any> {
      return this.http.delete(this.apiUrl5 + '/removeNodeFile'+'/DesielGenerator'+'/'+nodeId, { responseType: 'text' as 'json'})
    }
}
